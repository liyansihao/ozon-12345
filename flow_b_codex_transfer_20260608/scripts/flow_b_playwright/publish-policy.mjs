const PROHIBITED = [
  /еда|пищ|корм|food/i,
  /одеж|плать|fashion|服装|футболк|рубашк|поло\b|майк|брюк|джинс|куртк|пуховик|свитер|худи|толстовк|шорт|юбк/i,
  /трус|бюстгальтер|лифчик|нижн[\p{L}\p{M}]*\s+бель|носк|колгот|underwear|socks?/iu,
  /обув|балетк|ботин|сапог|кроссов|кед(?:ы|ы\b)|туфл|сандал|тапоч|shoes?|footwear/i,
  /шляп|панам|кепк|шапк|головн[\p{L}\p{M}]*\s+убор|headwear/iu,
