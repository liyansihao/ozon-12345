const PROHIBITED = [
  /(?<![\p{L}\p{N}])еда(?![\p{L}\p{N}])|пищ|корм|food/iu,
  ...
  /крем|cream|сыворот|serum|лосьон|lotion|тоник|тонер|toner|tonique|пилинг|peeling|скраб|scrub|умыван|cleanser|facial\s+wash|face\s+wash|увлажн|moistur|солнцезащит|sunscreen|spf|уход\s+(?:за\s+)?(?:кож|лиц)|skin\s*care|skincare|护肤|护理化妆品|面膜|眼贴膜|防晒|洗面奶|精华|爽肤水|卸妆|去角质|护肤霜|护肤凝胶|美容和卫生\s*>\s*(?:护理化妆品|面膜)/iu,
